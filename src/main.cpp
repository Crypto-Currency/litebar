...
uint256 hashGenesisBlock("0xca3e220f785070c8b8b8b993f9bce897ac0fdb27891973f558006d454a721e87");
...
static const int64 nTargetTimespan = 1.0 *24 * 60 * 60;	// LiteBar: 1 day
static const int64 nTargetSpacing = 180;						// LiteBar: 180 sec
...
bool CTransaction::ConnectInputs(CTxDB& txdb, MapPrevTx inputs, map<uint256,
     ...
     bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    // Take over previous transactions' spent pointers
    // fBlock is true when this is called from AcceptBlock when a new best-block is added to the blockchain
    // fMiner is true when called from the internal litebar miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LiteBar", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa6cdf7f06db9a27400fc2299ce2c9dec59d5433ce1f70a23161d8bfab16e61c6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "February 5, 2014: reconstruction of ltb";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391680734;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3836214;

        if (fTestNet)
        {
            block.nTime    = 1391632472;
            block.nNonce   = 2902728;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xca067cd91ba9b86363401c7d7dc08a43fed44c3500b3ec62d4c5630f3baf1604"));
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if (!vRecv.empty())
        {
          ...
          int iSubVer=pfrom->strSubVer.find("Litebar:0.8");
          if(iSubVer < 1)
          {
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // LiteBard: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
