...
// silly code didn't stop.
static const int64 MAX_MONEY = 1450000 * COIN; // LiteBar: maximum of 1.45M coins

//for testnet
//static const int64 MAX_MONEY = 140 * COIN; // LiteBar: maximum of 1.35M coins
